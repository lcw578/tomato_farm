...
def generate_launch_description():
    ...
    pkg_name = 'franka'  # the package name
    ...
    # 串收番茄/温室大棚等资产在 aoc_tomato_farm_gazebo 模型树中
    aoc_models_path = os.path.join(
        get_package_share_directory('aoc_tomato_farm_gazebo'), 'models', '22mx14m')

    if 'GAZEBO_MODEL_PATH' in os.environ:
        model_path = os.environ['GAZEBO_MODEL_PATH'] + ':' + models_path + ':' + aoc_models_path
    else:
        model_path = models_path + ':' + aoc_models_path

    world_path = os.path.join(pkg_share, 'worlds', 'tomato_farm_22mx14m_gazebo_classic.world')
